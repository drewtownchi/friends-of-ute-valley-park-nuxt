      ...
      <div class="mt-6 border-t border-gray-200 pt-10">
        <dl class="space-y-10 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12 md:space-y-0">
          <div v-for="(faq, i) in faqs" :key="i" class="space-y-2">
            ...
            <dd class="text-base text-gray-500" v-html="faq.answer" />
          </div>
        </dl>
      </div>
      <LeaveNoTraceSmall />
...
const faqs = [
  {
    ...
    answer:
      'Please download the <a class="font-semibold text-green-600 no-underline" href="/visit/">map</a> or take a picture of our new trail map before you head out on the trail and always remember the parking lot that you parked in; we have several to choose from.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Please see our <a class="font-semibold text-green-600 no-underline" href="/visit/">visit</a> page for trailhead information.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Please see our <a class="font-semibold text-green-600 no-underline" href="/volunteer/">volunteer</a> page.',
  },
];
</script>
