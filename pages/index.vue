            ...
            <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              <div class="group relative inline-flex">
                ...
                <a
                  ...
                  <span
                    class="rounded-full bg-gradient-to-r from-teal-500 to-green-600 px-3 py-0.5 text-sm font-semibold leading-5 text-white"
...
name="heroicons:chevron-right" class="ml-2 h-5 w-5 text-gray-500" aria-hidden="true" />
              ...
              <p class="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                ...
                >
                is an officially recognized “Friends” organization by the City of Colorado Springs Parks, Recreation,
                and Cultural Services Department. Our mission is to maintain, preserve, and provide education for Ute
                Valley Park.
              </p>
            </div>
...
class="relative" transition:name="hero">
    ...
    <div class="bg-white">
      <div class="mx-auto max-w-7xl py-12 sm:px-6 sm:py-24 lg:px-8">
        <div
          class="relative isolate overflow-hidden bg-green-800 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <svg
...
offset="1" stop-color="#E935C1" />
          ...
          <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-100">
              Donate or Volunteer today. Get involved and help Ute Valley Park by making a tax deductible donation or
              volunteering.
            </p>
