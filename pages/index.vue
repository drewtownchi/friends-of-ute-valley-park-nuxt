  ...
  <div>
    <div class="relative isolate">
      <svg class="absolute inset-x-0 top-0 -z-10 h-[64rem] w-full stroke-gray-200 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
           aria-hidden="true">
        <defs>
          <pattern id="1f932ae7-37de-4c0a-a8b0-a6e3b4d44b84"
                   width="200"
                   height="200"
                   x="50%"
                   y="-1"
                   patternUnits="userSpaceOnUse">
            <path d="M.5 200V.5H200"
                  fill="none" />
          </pattern>
        </defs>
        <svg x="50%"
      ...
      <div class="absolute left-1/2 right-0 top-0 -z-10 -ml-24 transform-gpu overflow-hidden blur-3xl lg:ml-24 xl:ml-48">
        <svg viewBox="0 0 801 1036"
             aria-hidden="true"
             class="w-[50.0625rem]">
          <path fill="url(#70656b7e-db44-4b9b-b7d2-1f06791bed52)"
                fill-opacity=".3"
          ...
          <defs>
            <linearGradient id="70656b7e-db44-4b9b-b7d2-1f06791bed52"
                            x1="508.179"
                            x2="-28.677"
                            y1="-116.221"
                            y2="1091.63"
            ...
            <div class="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
              <div class="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                <div class="relative"
                  ...
                  <NuxtPicture src="/img/heroes/ute-valley-park-hero.jpg"
                               width="300"
                               height="450"
                               sizes="150 md:300"
                               quality="60"
              ...
              <div class="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                <div class="relative">
                  <NuxtPicture src="/img/heroes/ute-valley-park-hero-2.jpg"
                               width="300"
                               height="450"
                               sizes="150 md:300"
                               quality="60"
                ...
                <div class="relative">
                  <NuxtPicture src="/img/heroes/ute-valley-park-hero-3.jpg"
                               width="300"
                               height="450"
                               sizes="150 md:300"
                               quality="60"
              ...
              <div class="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                <div class="relative">
                  <NuxtPicture src="/img/heroes/ute-valley-park-hero-4.jpg"
                               width="300"
                               height="450"
                               sizes="150 md:300"
                               quality="60"
                ...
                <div class="relative">
                  <NuxtPicture src="/img/heroes/ute-valley-park-hero-5.jpg"
                               width="300"
                               height="450"
                               sizes="150 md:300"
                               quality="60"
      ...
      <div class="mx-auto max-w-7xl py-12 sm:px-6 sm:py-24 lg:px-8">
        <div class="relative isolate overflow-hidden bg-green-800 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div class="relative mt-16 h-80 lg:mt-8">
            <NuxtPicture :img-attrs="{class: 'absolute left-0 top-0 w-[47rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10'}"
