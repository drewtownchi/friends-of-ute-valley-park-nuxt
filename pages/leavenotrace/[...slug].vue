    ...
    <div class="relative isolate mt-1 overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div
        ...
        <div
          ...
          <div class="lg:pr-4">
            <div class="lg:max-w-lg">
              <p class="text-base font-semibold leading-7 text-green-600">Leave No Trace</p>
        ...
        <div
          ...
          <div class="lg:pr-4">
            <div
              class="prose prose-xl max-w-xl text-base leading-7 text-gray-700 prose-headings:text-green-600 prose-a:text-green-600 lg:max-w-lg">
