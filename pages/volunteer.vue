<template>
  <div>
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <NuxtPicture src="img/volunteer/volunteer-hero-mask.jpg"
                   alt=""
    ...
    <div>
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <h2 v-if="upcomingVolunteerEvents.length > 0"
            class="text-3xl font-bold tracking-tight text-green-800 sm:text-4xl">
          Upcoming volunteer events
        </h2>
        <div class="px-4 py-5">
          <ul class="divide-y divide-gray-100">
            <VolunteerListItem v-for="volunteerEvent in upcomingVolunteerEvents"
        ...
        <div class="border-gray-200 pt-8 xl:grid xl:grid-cols-3 xl:gap-x-8">
          <div>
            <NuxtPicture src="img/volunteer/volunteer-3.jpg"
          ...
          <div class="col-span-2">
            <ul class="ml-4 list-disc divide-y divide-gray-200 text-gray-700">
              <li class="py-3">
                <span class="font-bold">Volunteer days:</span> the 1st and 3rd Wednesday of every month,
              ...
              <li class="py-3">
                ...
                page or register for our newsletter below for additional volunteer opportunities,
                meeting locations and updates.
              </li>
              <li class="py-3">
                Volunteer and get a free beverage, stickers and buttons! After 4 hours of volunteer work
                you will receive a free beverage (beer or non-alcoholic) at our end of year appreciation
                party.
              </li>
              <li class="py-3">
                All tools provided.
              ...
              <li class="py-3 font-semibold">
                You must wear pants and closed toed shoes and please bring gloves and safety goggles or
                sunglasses.
              </li>
            </ul>
          </div>
    ...
    <div class="bg-white py-16">
      <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
        <div class="max-w-xl text-2xl font-bold text-gray-900 sm:text-4xl lg:col-span-6">
          <h2 class="inline tracking-tight sm:block lg:inline xl:block">
            Get Notified!
          </h2>
