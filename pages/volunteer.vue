<template>
  <div>
    ...
    <div>
          ...
          <div class="lg:pr-8 lg:pt-4">
            <div class="lg:max-w-lg">
              <h2 class="text-base font-semibold leading-7 text-green-600">
                Make a Difference, Make Friends, and Have Fun!
              </h2>
              <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Join Ute Valley Park's Volunteer Team and Discover the Joy of Giving Back
              </p>
              <p class="mt-6 leading-8 text-gray-700">
                Want to have fun while making a meaningful impact in your community? Become a volunteer at Ute Valley
                Park! Our team welcomes people of all ages and abilities, offering a variety of rewarding tasks to suit
                your interests and skills. From maintaining trails, building drains and seeding native grass to closing
                rogue paths, there's something for everyone to contribute.
              </p>
              <p class="mt-6 leading-8 text-gray-700">
                As a Ute Valley Park volunteer, you'll work alongside a friendly, diverse group of individuals who share
                your enthusiasm for preserving this beloved natural resource. Not only will you forge new connections
                with fellow nature lovers, but you'll also take pride in knowing your efforts directly benefit the park
                and all who visit it. Experience the joy of giving back and making a difference - volunteer at Ute
                Valley Park today! Your community will appreciate your dedication.
              </p>
              <a href="#learnmore" class="my-2 block font-semibold text-green-700 underline"
                >Learn more<span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
          <NuxtPicture
            src="img/volunteer/volunteer-4.jpg"
      ...
      <div id="learnmore" class="mt-8 border-b border-gray-200 pb-5 pt-4">
        <h3 class="text-3xl font-medium leading-6 text-green-900">Learn More About Volunteering in Ute Valley Park</h3>
      </div>
      <div class="border-gray-200 py-8 xl:grid xl:grid-cols-3 xl:gap-x-8">
        <div>
          <NuxtPicture
        ...
        <div class="col-span-2">
          <ul class="ml-4 list-disc divide-y divide-gray-200 text-gray-700">
            ...
            <li class="py-3">
              ...
              page or register for our newsletter for additional volunteer opportunities, meeting locations and
              updates.
            </li>
            <li class="py-3">
              Volunteer and get a free beverage, stickers and buttons! After 4 hours of volunteer work you will receive
              a free beverage (beer or non-alcoholic) at our end of year appreciation party.
            </li>
