    ...
    <HeadlessDisclosure v-slot="{ open }"
        ...
        <div class="flex h-16 justify-between">
          <div class="flex">
            <div class="flex flex-shrink-0 items-center">
              <NuxtPicture class="block h-14 w-14"
                           width="56"
                           height="56"
                  ...
                  <transition enter-active-class="transition ease-out duration-200"
                    ...
                    <HeadlessPopoverPanel class="absolute left-1/2 z-10 mt-16 flex w-screen max-w-max -translate-x-1/2 px-4">
                      <div class="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
                        <div class="p-4">
                          <div v-for="item in leaveNoTraceMenuItems"
                               :key="item.name"
      ...
      <HeadlessDisclosurePanel class="sm:hidden">
        <div class="space-y-1 pb-3 pt-2">
          ...
          <HeadlessDisclosureButton v-for="item in navigation"
                                    :key="item.name"
                                    as="a"
                                    :href="item.href"
                                    :class="[
        ...
        <div class="space-y-1 border-t border-gray-200 pt-6">
          <HeadlessDisclosureButton v-for="item in leaveNoTraceMenuItems"
                                    :key="item.name"
                                    as="a"
                                    :href="item.href"
                                    :class="[
