            ...
            <div class="flex h-full justify-center">
              <HeadlessPopover class="relative flex">
                <HeadlessPopoverButton
                  :class="[
                    path.startsWith('/leavenotrace') === true
                      ? 'border-green-500 text-gray-900'
                      : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700',
                    'inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium',
                  ]">
                  <span class="items-center">Leave No Trace</span>
                  <Icon name="heroicons:chevron-down" class="ml-1 h-5 w-5" aria-hidden="true" />
                </HeadlessPopoverButton>
                <transition
                  ...
                  <HeadlessPopoverPanel
                    class="absolute left-1/2 z-10 mt-16 flex w-screen max-w-max -translate-x-1/2 px-4">
                    <div
